$(function() {
	...
	const onMouseOver = (e, fill, ctaContent) => {
	...
	const onMouseOut = (e, fill, ctaContent) => {
		console.log("reset")
	...
	let images = document.querySelectorAll('.selection_item img, .blob-cta img')
	...
	images.forEach((image, index) => {
		...
		function getFormat() {
			...
			if (image.hasAttributes('data-fill, data-cta')) {
				...
				// attach listeners for functions
				image.addEventListener('mouseover', onMouseOver(fill, ctaContent));
				image.addEventListener('mouseout', onMouseOut(fill, ctaContent));
